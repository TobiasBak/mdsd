 ...
 */
export type GoatJhServices = LangiumServices & GoatJhAddedServices
 ...
 */
export function createGoatJhServices(context: DefaultSharedModuleContext): {
    shared: LangiumSharedServices,
    GoatJh: GoatJhServices
} {
    const shared = inject(
        createDefaultSharedModule(context),
        GoatJhGeneratedSharedModule
    );
    const GoatJh = inject(
